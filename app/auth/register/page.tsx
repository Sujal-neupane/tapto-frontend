  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="flex min-h-screen relative z-10">
              ...
              <div className="space-y-6 max-w-xl">
                <div className="space-y-2">
                  ...
                  <h1 className="text-5xl font-bold leading-tight">
                    Create your <span className="text-yellow-300">account</span> today.
                  </h1>
                  <p className="text-lg text-blue-100 leading-relaxed">
                    Sign up to unlock a world of personalized shopping and exclusive deals.
                  </p>
                </div>
        ...
        {/* Right Side - Register Form with creative design */}
