...
import { User, Mail, Phone, Camera, Save, ArrowLeft, Shield, Check, X, Edit3, Upload, LogOut, Globe, DollarSign, MapPin, Calendar, Hash } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-primary-50 to-primary-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-3 animate-slideIn" style={{ animationDelay: '100ms' }}>
                ...
                <input
                  ...
                  value={form.fullName}
                  onChange={handleChange}
                  className="w-full text-black px-5 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-50 transition-all duration-200 bg-gray-50/50 hover:bg-white"
              ...
              <div className="space-y-3 animate-slideIn" style={{ animationDelay: '400ms' }}>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full text-black px-5 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-50 transition-all duration-200 bg-gray-50/50 hover:bg-white cursor-pointer"
                >
        ...
        {/* Account Details & Currency Card */}
        <div className="mt-6 grid md:grid-cols-2 gap-6 animate-fadeIn" style={{ animationDelay: '600ms' }}>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Currency & Region</h3>
                <p className="text-xs text-gray-500">Based on your registration country code</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                ...
                <div className="text-right">
                  <span className="inline-flex items-center gap-1 px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-lg text-sm font-bold">
              ...
              <div className="flex items-center gap-2 px-3 py-2 text-xs text-gray-500">
                ...
                <span>All product prices are displayed in <strong className="text-gray-700">{currency.code}</strong> automatically</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono text-gray-700">{(user?._id || (user as any)?.id || 'N/A').slice(-8)}...</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-700">{(user as any)?.createdAt ? new Date((user as any).createdAt).toLocaleDateString('en-US', { month: 'long', year: 'numeric' }) : 'Active Member'}</p>
                </div>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 text-xs text-gray-500">
